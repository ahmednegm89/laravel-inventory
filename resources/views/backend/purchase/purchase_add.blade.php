                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label style="width: auto" for="example-text-input" class="col-sm-2 col-form-label">purchase num</label>
                                    <input name="purchase_num" class="form-control" type="text" id="purchase_num">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label style="width: auto" for="example-text-input" class="col-sm-2 col-form-label">supplier name</label>
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label style="width: auto" class="col-sm-2 col-form-label">category</label>
                            ...
                            <div class="col-md-4">
                                <div class="md-3">
                                    <label style="width: auto" class="col-sm-2 col-form-label">product name</label>
...
<script id="document-template" type="text/x-handlebars-template">
    ...
    <tr class="delete_add_more_item" id="delete_add_more_item">
            ...
            <input type="hidden" name="purchase_num[]" value="@{{purchase_num}}">
